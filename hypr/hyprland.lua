...
hl.exec_cmd("nm-applet & systemctl --user start hyprpolkitagent")
hl.exec_cmd("otd-daemon")
hl.exec_cmd("wayle panel start & hyprpaper & awww-daemon & awww img '/home/dreamhunter/Documents/MC screenshots/silzy gre photo.png'")
hl.exec_cmd("vesktop -silent & steam -silent & vivaldi & obsidian")
end)
